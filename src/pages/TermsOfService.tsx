...
const CLAUSES: Clause[] = [
  ...
  },
  {
    ...
    body_he: [
      ...
      'בהתאם לחוק הגנת הצרכן, התשמ"א-1981 (כפי שתוקן), ובפרט להוראות בדבר ביטול עסקאות שנרכשו דרך האינטרנט: (א) ניתן לבטל עסקה תוך 14 יום מיום ההתקשרות הראשוני בתנאי שלא נעשה שימוש בשירות — ולקבל החזר מלא; (ב) לאחר שימוש בשירות או לאחר תום 14 הימים, הביטול ייכנס לתוקף בתום תקופת החיוב הנוכחית ולא יינתן החזר כספי יחסי (Proration) בגין התקופה שנותרה; (ג) חידושי מנוי חודשיים סופיים ואינם ניתנים להחזר בכל מקרה לאחר תחילת תקופת החיוב החדשה; (ד) זכויות הצרכן המנויות בחוק גוברות על כל תנאי הסכם זה.',
    ...
    body_en: [
      ...
      'In accordance with the Consumer Protection Law, 5741-1981 (as amended), and in particular the provisions regarding cancellation of transactions purchased via the internet: (a) a transaction may be cancelled within 14 days of the initial transaction date provided the Service has not been used — for a full refund; (b) after Service use or after the 14-day window, cancellation takes effect at the end of the current billing period and no prorated refund (Proration) will be issued for the remaining period; (c) monthly subscription renewals are final and non-refundable in all circumstances once the new billing period has commenced; (d) consumer rights specified in applicable law prevail over any terms of this Agreement.',
          ...
          {CLAUSES.map((clause, i) => (
            ...
            >
              ...
              <div className="flex items-start gap-3 mb-4">
                <div
                  className="flex-none flex h-7 w-7 items-center justify-center rounded-lg text-[11px] font-black text-indigo-700 dark:text-indigo-300"
                  style={{
                ...
                <h2
                  className="text-[15px] font-bold leading-tight text-violet-700 dark:text-violet-300"
                >
