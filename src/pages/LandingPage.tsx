...
const copy = {
  he: {
    ...
    // Marquee
    marqueeItems: ['94% אחוז אישור', 'סגירה 2× מהירה', '₪2.3M+ עסקאות', '500+ פרילנסרים', 'דירוג 4.9/5', 'חתימה דיגיטלית חוקית', 'PDF מוסמך אוטומטי', 'ללא כרטיס אשראי'],

    // How It Works
    howLabel: 'שלושה שלבים. עסקה אחת.',
    howH2part1: 'מ-PDF מתישׁ',
    howH2Highlight: 'לחדר עסקאות',
    howH2part2: 'שסוגר.',
    steps: [
      { num: '01', tag: 'בנייה', tagEn: 'Build', title: 'בנו ב-2 דקות', body: 'פרטי פרויקט, תמחור, תוספות, תבנית חוזה. AI כותב את הטקסט בשבילכם.' },
      { num: '02', tag: 'שליחה', tagEn: 'Send',  title: 'שלחו קישור אחד', body: 'הלקוח מקבל קישור שעובד על כל מכשיר — ללא התקנות, ללא כניסה לחשבון.' },
      { num: '03', tag: 'סגירה', tagEn: 'Signed', title: 'הלקוח חתם', body: 'חתימה דיגיטלית, PDF מוסמך, והתראה מיידית — הכל בלחיצה אחת.' },
    ],
    ...
    vsSub: 'כמה PDF נגמרו אצלכם אתמול בסל המחזור? הגיע הזמן להפסיק לשלוח קבצים.',
    problemItems: [
    ...
    solutionItems: [
      ...
      'הלקוח מתאים תוספות בעצמו, הסכום מתעדכן חי',
      'חתימה דיגיטלית + PDF מוסמך תוך שניות',
    ],
    ...
    bento: [
      ...
      { icon: 'sparkles', tag: 'AI Ghostwriter', title: 'טקסט מקצועי תוך שניות',          body: 'AI כותב תיאורי פרויקט בסגנון קופירייטר בכיר — בעברית ובאנגלית.',             wide: false },
      { icon: 'sign',   tag: 'חתימה דיגיטלית',  title: 'חתמו ב-60 שניות',                 body: 'חתימה ייחודית, PDF מוסמך ורשומת ביקורת מלאה. הכל חוקי לפי חוק חתימה אלקטרונית.', wide: true  },
      ...
      { icon: 'download', tag: 'PDF מוסמך',      title: 'PDF ברמה עסקית — אוטומטי',       body: 'כל עסקה חתומה מייצרת PDF מוסמך עם חתימה, timestamp ורשומת ביקורת מלאה.',    wide: false },
    ],
    ...
    testimonials: [
      ...
      { name: 'נועה ש.', role: 'מעצבת UX/UI',              text: 'שלחתי ביום שני. חתמו ביום שלישי בבוקר. חשבתי שזו תקלה — זה לא היה.', stars: 5 },
