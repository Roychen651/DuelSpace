...
export const KB_CATEGORIES = [
  ...
  { key: 'services_contracts', label_he: 'שירותים ותנאים',         label_en: 'Services & Terms',          color: '#34d399' },
...
export const KNOWLEDGE_BASE: KBItem[] = [
  ...
  },
  {
    ...
    a_he: 'תנאי העסק הם תקנון שאתה מגדיר פעם אחת בפרופיל (פרופיל ← תנאי העסק / תנאים והתניות) ומוקפאים אוטומטית בכל הצעה חדשה. עורך TipTap עשיר זמין — כתוב: תנאי תשלום, בעלות קניין רוחני, אחריות, מדיניות ביטולים, ועוד. הלקוח רואה אותם בחדר הדיל ומסכים אליהם בצ׳קבוקס ייעודי לפני החתימה.',
    a_en: 'Business Terms are a T&C document you define once in your Profile (Profile → Business Terms & Conditions) and are automatically frozen into every new proposal. A full TipTap rich-text editor is available — write: payment terms, IP ownership, liability, cancellation policy, and more. The client sees them in the Deal Room and must agree via a dedicated checkbox before signing.',
  },
  {
    category: 'services_contracts',
    ...
    a_he: 'תנאי DealSpace הם תנאי השימוש של הפלטפורמה עצמה — DealSpace כתשתית טכנולוגית, מדיניות פרטיות וכו׳. תנאי העסק הם התנאים שאתה — העסק שלך — קובע עם הלקוח: תשלומים, בעלות על התוצרים, ביטולים ועוד. שני הסטים מוצגים בנפרד בחדר הדיל ונכללים יחד ב-PDF החתום.',
    a_en: 'DealSpace Terms are the platform\'s own terms of service — DealSpace as a technology infrastructure, privacy policy, etc. Business Terms are the terms you — your business — set with your client: payments, ownership of deliverables, cancellations, and more. Both sets appear separately in the Deal Room and are included together in the signed PDF.',
  },
  {
    category: 'services_contracts',
    q_he: 'הלקוח רוצה לעיין בתנאים שוב אחרי שחתם — האם אפשר?',
    q_en: 'The client wants to re-read the terms after signing — is that possible?',
    a_he: 'בהחלט. תנאי העסק מוצגים בחדר הדיל לכל מי שפותח את הקישור — גם לאחר החתימה. הלקוח יכול לחזור לקישור בכל עת ולקרוא את התנאים. בנוסף, ה-PDF החתום מכיל סקשן "תנאי העסק" — הלקוח יכול להוריד אותו בלחיצה אחת על "הורד חוזה חתום (PDF)" בדף הממחוזר.',
    a_en: 'Absolutely. Business Terms are displayed in the Deal Room for anyone who opens the link — including after signing. The client can return to the link at any time and read the terms. Additionally, the signed PDF contains a "Business Terms" section — the client can download it with one click on "Download Signed Contract (PDF)" on the sealed page.',
  },
  {
    category: 'services_contracts',
    q_he: 'האם תנאי העסק נכנסים לקובץ ה-PDF החתום?',
    q_en: 'Are business terms included in the signed PDF?',
    a_he: 'כן, אוטומטית. מנוע ה-PDF של DealSpace מוסיף סקשן "תנאי העסק" לעמוד התוכן של ה-PDF — לאחר תיאור הפרויקט ולפני תעודת החתימה. הפורמט מושמר: כותרות, מודגש, רשימות — בדיוק כפי שכתבת בפרופיל. כך הלקוח מקבל מסמך אחד שלם הכולל הצעה + תנאים + חתימה.',
    a_en: 'Yes, automatically. DealSpace\'s PDF engine adds a "Business Terms" section to the PDF content page — after the project description and before the signature certificate. Formatting is preserved: headings, bold, lists — exactly as written in your Profile. The client receives one complete document containing the proposal + terms + signature.',
  },
  {
    category: 'services_contracts',
    q_he: 'מה ניתן לעצב בעורכי הטקסט (תיאור הפרויקט, תנאי העסק)?',
    q_en: 'What formatting is available in the text editors (project description, business terms)?',
    a_he: 'שני העורכים (בבונה ובפרופיל) מבוססים על TipTap ותומכים: כותרות H1-H3, מודגש, נטוי, רשימות ממוספרות ונקודות, קישורים. ניתן לכתוב בעברית ואנגלית. הפורמט מוצג בחדר הדיל ובחוזה ה-PDF — ללא מגבלת אורך.',
    a_en: 'Both editors (in the Builder and in Profile) are TipTap-based and support: H1-H3 headings, bold, italic, numbered and bulleted lists, links. You can write in Hebrew and English. Formatting renders faithfully in the Deal Room and PDF contract — no length limit.',
  },
  {
    category: 'services_contracts',
...

  {
    ...
    a_he: 'בסעיף "פרטי לקוח" בבונה, הזן קוד גישה בן 4 ספרות. הלקוח שפותח את הקישור יראה תחילה מסך קוד — רק אחרי הקלדת הקוד הנכון הוא ייכנס לחדר הדיל. כך מונעים גישה בשוגג לצדדים לא רלוונטיים. שלח את הקוד ללקוח בנפרד (SMS/WhatsApp).',
    a_en: 'In the "Client Details" section in the Builder, enter a 4-digit access code. The client who opens the link will first see a PIN screen — only after entering the correct code will they enter the Deal Room. This prevents accidental access by unintended parties. Send the code to the client separately (SMS/WhatsApp).',
  },
  {
    category: 'creating_proposals',
